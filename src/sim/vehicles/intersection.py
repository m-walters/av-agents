...
from highway_env.vehicle.behavior import AggressiveVehicle as AggVehicle, LinearVehicle
from highway_env.vehicle.controller import ControlledVehicle


class DefaultParams:
    """
    Default params from the highway_env IntersectionEnv class
    """
    DISTANCE_WANTED = 7
    COMFORT_ACC_MAX = 6
    COMFORT_ACC_MIN = -3
...
class Vehicle(DefaultParams, LinearVehicle):
    """
...
class AggressiveVehicle(AggressiveParams, AggVehicle, Vehicle):
    pass
